...
from data.custom_itr_dataset import custom_itr_retrieval_eval
...
def create_dataset(dataset, config, min_scale=0.5):
    ...
    elif dataset=='retrieval_custom_itr':          
        train_dataset = custom_itr_retrieval_eval(transform_test, config['image_root'], config['train_file'])
        val_dataset = custom_itr_retrieval_eval(transform_test, config['image_root'], config['val_file'])
        test_dataset = custom_itr_retrieval_eval(transform_test, config['image_root'], config['test_file'])
        return train_dataset, val_dataset, test_dataset  
