...
def evaluation(model, dset, tokenizer, device, config):
    ...
    for example in tqdm(dset):
        ...
        image_embeds_0, image_atts_0 = model.get_vision_embeds(image_0.unsqueeze(0))
        image_embeds_1, image_atts_1 = model.get_vision_embeds(image_1.unsqueeze(0))
        text_embeds_0 = model.get_text_embeds(text_input_0.input_ids, text_input_0.attention_mask)
        text_embeds_1 = model.get_text_embeds(text_input_1.input_ids, text_input_1.attention_mask)

        cross_c0_i0 = model.get_cross_embeds(image_embeds_0, image_atts_0, text_embeds=text_embeds_0, text_atts=text_input_0.attention_mask)[:, 0, :]
        cross_c0_i1 = model.get_cross_embeds(image_embeds_1, image_atts_1, text_embeds=text_embeds_0, text_atts=text_input_0.attention_mask)[:, 0, :]
        cross_c1_i0 = model.get_cross_embeds(image_embeds_0, image_atts_0, text_embeds=text_embeds_1, text_atts=text_input_1.attention_mask)[:, 0, :]
        cross_c1_i1 = model.get_cross_embeds(image_embeds_1, image_atts_1, text_embeds=text_embeds_1, text_atts=text_input_1.attention_mask)[:, 0, :]

        itm_logits_c0_i0 = model.itm_head(cross_c0_i0)
        itm_logits_c0_i1 = model.itm_head(cross_c0_i1)
        itm_logits_c1_i0 = model.itm_head(cross_c1_i0)
        itm_logits_c1_i1 = model.itm_head(cross_c1_i1)
