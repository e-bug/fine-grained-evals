...
@torch.no_grad()
def evaluation(model, instrument2data, instrument2piece, tokenizer, device, config, args):
    model.eval()
...
def main(args, config):
    ...
    test_scores = evaluation(model_without_ddp, instrument2data, instrument2piece, tokenizer, device, config, args)
